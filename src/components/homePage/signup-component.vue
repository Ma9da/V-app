<template>
	...
	>
		...
		<img
			src="../../assets/images/homePage/letters.png"
			relative
			class="z-3"
		/>
...
.btn-shadow {
	box-shadow: 10px 10px 35px 6px rgba(28, 207, 61, 0.3);
	-webkit-box-shadow: 10px 10px 35px 6px rgba(28, 207, 61, 0.3);
	-moz-box-shadow: 10px 10px 35px 6px rgba(28, 207, 61, 0.3);
}
.back-ground {
