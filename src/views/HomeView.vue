<template class="relative z-0">
	...
	<div class="overflow-hidden hidden lg:block md:block">
		<div
			class="-z-1 bg-#8612EA w-165 h-165 absolute bottom-0 right--6% top--40% radius rotate-40 overflow-hidden"
		>
			<div
				class="bg-no-repeat w-full h-full rounded-3xl relative top-21% rotate--40 overflow-hidden"
				style="
			...
			<div class="relative bottom-32% left-50%">
				<img
					src="../../src/assets/images/homePage/whitePlane.png"
					class="w-60% rotate--40"
				/>
			</div>
		</div>
	</div>
	<el-row class="mb-10 content-center justify-center">
		<card-component></card-component>
	</el-row>

	<el-row class="mb-10 design-column">
		<el-col
			:span="24"
			:md="13"
			:sm="15"
		...
		<el-col
			:span="24"
			:md="12"
			class="py-2 display-flex justify- items-center"
		>
			<el-card
				class="display-flex flex-col justify-center items-center rounded-3 w-fit mt-0 sm:mt-10 sm:mx-auto"
			>
				<template #header>
				...
				<el-row class="mb-5">
					...
					<el-col :span="6" class="display-flex items-center">
						<el-row class="items-center">
							<el-col :span="12">
								<span
									class="text-#5808d8 text-center font-bold text-2xl"
								>
									=</span
								>
							</el-col>
				...
				<el-row class="text-#5808D8 font-bold">
					<el-col :span="12"> Collect 10 nights </el-col>
			...
			<img
				...
				class="w-30 pb-80 hidden lg:block"
			/>
		</el-col>

		<el-col :span="24" :md="12" :sm="24" class="text-#42436A px-4 py-2">
			<h1 class="lg:md:pl-20 w-60 pb-4 text-7 leading-10">
				Happy Trip Loyality Program
				<hr class="heder-line" />
			</h1>

			<p class="lg:md:pl-20 leading-6 mb-15">
				...
				and good vibes - whatever your adventure, it starts right here.
				As the world's largest student and youth travel company, we've
				been booking affordable adventures for awesome good vibes -
				whatever your adventure, it starts right here.
			</p>

			<el-button
				size="large"
				class="ml-20 bg-#1CCF3D text-white font-bold shadow-xl"
			>
	...
	<el-row
		class="mb-20 text-white sm:pt-20 lg:pt-40 bg-gradient-to-r from-#8612EA to-#4406D1"
	>
		<el-col :span="24" :lg="12" :md="12">
			<div class="p-2.5">
				<h2>Get the Happy Trip App !</h2>
				<p class="w-full lg:w-80 sm:w-full leading-6">
					Looking to manage your flight and hotel needs efficiently?
					BlazeBe does exactly that for you in a few simple taps with
					artistic user interface and secure payment channels.
				</p>
				<el-button class="bg-transparent text-white"
					>Get the app
				</el-button>
			</div>
		</el-col>

		<el-col :span="24" :lg="12" :md="12" class="relative flex">
			<div class="flex justify-end relative">
				<img
					src="@/assets/images/getAppDevice1.png"
					alt=""
					class="absolute top-20% right-70% hidden md:lg:block"
				/>
				<img
					src="@/assets/images/getAppDevice2.png"
					alt=""
					class="sm:w-50 lg:md:w-full hidden md:lg:block"
				/>
			</div>
		</el-col>
	...
	<el-row class="justify-between mb-10 px-0 lg:md:px-20">
		<el-col :span="20" :md="10">
			<el-row>
				<el-col :span="24" class="mb-10">
					<el-card
						class="rounded-l-0 mx-5 rounded-r-3 border-l-3 border-l-#FDD500 relative overflow-visible w-full lg:w-96"
						:body-style="{
				...
				<el-col :span="24" class="mb-10 lg:ml-30 sm:ml-0">
					<el-card
						class="rounded-l-0 mx-5 rounded-r-3 border-l-3 border-l-#00D8FD relative overflow-visible w-full lg:w-96"
						:body-style="{
							padding: '10px 10px 10px 20px',
						}"
					>
				...
				<el-col :span="24" class="mb-10">
					<el-card
						class="rounded-l-0 mx-5 rounded-r-3 border-l-3 border-l-#FF1E74 relative overflow-visible w-full lg:w-96"
						:body-style="{
							padding: '10px 10px 10px 20px',
						}"
					>
		...
		<el-col
			...
			:lg="12"
			:md="12"
			class="text-#42436A py-2 flex flex-col justify-center"
		>
			<h1 class="px-10 text-7 leading-10">Why work with us?</h1>

			<p class="px-10 leading-6 mb-15">
				You are unique, and so is your trip. When you book with Liberty
				Travel, we match you with an expert best suited to design a
...
.design-column {
	background-image: url(../assets/images/homePage/bubblesGround.png);
