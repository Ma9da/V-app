<template class="relative z-0">
				...
				>
					...
					>
						<el-col :span="12" class="display-flex">
							<el-button
								size="large"
								:type="isFlights ? 'primary' : 'default'"
								class="flex-grow-1 rounded-3 border-none mx-1"
								@click="isFlights = true"
								>Flight
							</el-button>
						</el-col>
						<el-col :span="12" class="display-flex">
							<el-button
								size="large"
								:type="isFlights ? 'default' : 'primary'"
								class="flex-grow-1 rounded-3 border-none mx-1"
								@click="isFlights = false"
								>Hotel
							</el-button>
						</el-col>
					</el-row>
					...
					<el-row :class="isFlights ? 'block' : 'hidden'">
						<el-col :span="24">
							<el-tabs v-model="activeTab" :stretch="true">
								<el-tab-pane label="One Way" name="first"
									>One Way</el-tab-pane
								>
								<el-tab-pane label="Round Trip" name="second"
									>Round Trip
								</el-tab-pane>
								<el-tab-pane label="Multicity" name="third"
									>Multicity
								</el-tab-pane>
							</el-tabs>
						</el-col>
			...
			<el-col :span="24" :class="isFlights ? 'block' : 'hidden'">
				...
				<el-row>
					<el-col :span="24" class="display-flex">
						<el-button
							size="large"
							class="flex-grow-1 text-white font-bold bg-#1CCF3D"
							>{{
								isFlights
									? "Search Flights"
									: "Check Availibility"
	...
	<el-row class="mb-10">
		...
		<el-col :span="24" :md="12" class="text-#42436A px-4 py-2">
			...
			<el-button
				size="large"
				class="bg-#1CCF3D text-white font-bold shadow-xl"
			>
	...
	<el-row
		class="mb-20 text-white py-20 lg:py-60 bg-gradient-to-r from-#8612EA to-#4406D1"
	>
		<el-col :span="24" :md="12">
			<div class="p-5 lg:py-15 ">
		...
		<el-col :span="24" :md="12" class="relative">
			<img
				...
				alt=""
				class="hidden lg-block absolute -top-1/4 right-2/4"
			/>
			<img
				src="@/assets/images/getAppDevice2.png"
				alt=""
				class="hidden lg-block absolute absolute -top-4/4 left-1/4"
			/>
		</el-col>
